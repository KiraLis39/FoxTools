...
public class SystemInfo {
	...
	public void printAll() {
		...
		log.info("Кодировка системы: " + System.getProperty("file.encoding") + " ("	+ System.getProperty("sun.jnu.encoding") + ")");
	...
	public static class MEMORY {
		...
		public long getMaxJvmMemory() {return Runtime.getRuntime().maxMemory();}
		public long getUsedJvmMemory() {return Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();}
		public long getFreeJvmMemory() {return Runtime.getRuntime().freeMemory();} // (Memory / 1048576L) = "мб"
		
		public long getTotalSystemMemory() {return os.getTotalMemorySize();}
		public long getFreeSystemMemory() {return os.getFreeMemorySize();}
		public long getTotalSwapMemory() {return os.getTotalSwapSpaceSize();}
		public long getFreeSwapMemory() {return os.getFreeSwapSpaceSize();}
		public long getCommittedVirtualMemory() {return os.getCommittedVirtualMemorySize();} // (Memory / 1048576L) = "мб"
	}
